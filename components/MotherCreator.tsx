...
const AVATARS = [
  { id: "1", emoji: "🌸", color: "#FFF0EB", label: "温柔" },
          ...
          <div className="w-full max-w-xs space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="如：小明、宝贝"
                className="w-full px-4 py-3 rounded-xl border border-[#F0E0CF] bg-[#FFF7F0] text-gray-800 text-sm focus:outline-none focus:border-[#E8927C] placeholder-gray-400"
              />
            </div>
            <button
              onClick={() => nickname.trim() && setStep(2)}
              disabled={!nickname.trim()}
              className="w-full py-3 rounded-xl bg-[#E8927C] text-white font-medium hover:bg-[#D47E6A] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              继续
            </button>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="如：李妈妈"
                className="w-full px-4 py-3 rounded-xl border border-[#F0E0CF] bg-[#FFF7F0] text-gray-800 text-sm focus:outline-none focus:border-[#E8927C]"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 accent-[#E8927C]"
                />
                ...
                {PERSONALITIES.map((p) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-xl border transition-colors ${
                      personality === p.value
                        ? "border-[#E8927C] bg-[#FFF7F0]"
                        : "border-[#F0E0CF] bg-white hover:bg-[#FFF5ED]"
                    }`}
                  >
                ...
                {AVATARS.map((a) => (
                  <button
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center text-2xl transition-all ${
                      avatarUrl === a.emoji
                        ? "ring-2 ring-[#E8927C] ring-offset-2 scale-110"
                        : "hover:scale-105"
                    }`}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 rounded-xl border border-[#F0E0CF] bg-[#FFF7F0] text-gray-800 text-sm focus:outline-none focus:border-[#E8927C] placeholder-gray-400 resize-none"
              />
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <button
                onClick={() => setStep(1)}
                className="flex-1 py-3 rounded-xl border border-[#F0E0CF] bg-white text-gray-600 font-medium hover:bg-gray-50 transition-colors"
              >
                上一步
              </button>
              <button
                ...
                className="flex-1 py-3 rounded-xl bg-[#E8927C] text-white font-medium hover:bg-[#D47E6A] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {saving ? "创建中..." : "创建母亲"}
              </button>
            </div>
