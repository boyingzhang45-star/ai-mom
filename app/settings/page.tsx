...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF7F0] max-w-lg mx-auto">
      <header className="flex items-center gap-4 px-4 py-3 bg-white/90 backdrop-blur-sm border-b border-[#F0E0CF]">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="text-[#E8927C] text-sm font-medium disabled:opacity-50"
        >
          {saving ? "保存中..." : "保存"}
        </button>
      </header>
      ...
      <div className="px-6 py-8 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 rounded-xl border border-[#F0E0CF] bg-white text-gray-800 text-sm focus:outline-none focus:border-[#E8927C] placeholder-gray-400 resize-none"
          />
        </div>
      </div>
    </div>
